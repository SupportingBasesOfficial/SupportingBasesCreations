  ...
  return (
    <div className="flex h-full w-full items-center justify-center bg-gray-50 dark:bg-gray-950">
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="h-2 w-24 animate-pulse rounded bg-gray-100 dark:bg-gray-700" />
      </div>
    </div>
  );
}
...
export function SidebarSkeleton() {
  return (
    <div className="flex h-full w-60 flex-col border-r border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
...
export function InspectorSkeleton() {
  return (
    <div className="flex h-full w-72 flex-col border-l border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
      ...
      <div className="space-y-3">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="space-y-1">
            ...
            <div className="h-8 w-full animate-pulse rounded bg-gray-100 dark:bg-gray-800" />
          </div>
        ))}
      </div>
    </div>
